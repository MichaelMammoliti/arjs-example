...
function jd(s) {
  w(
    ...
    w(
      s.length >= 1,
      () => `Must pass at least one tensor to tf.addN(), but got ${s.length}`,
    );
  const e = s.map((r, n) => y(r, `tensors${n}`, 'addN')),
    t = e[0];
  e.forEach((r) => {
    if (r.dtype !== t.dtype)
      throw new Error(
...
function Bd(s, e, t, a, r, n) {
  const u = y(s, 'forgetBias', 'basicLSTMCell'),
    o = y(e, 'lstmKernel', 'basicLSTMCell'),
    l = y(t, 'lstmBias', 'basicLSTMCell'),
    p = y(a, 'data', 'basicLSTMCell'),
    m = y(r, 'c', 'basicLSTMCell'),
    c = y(n, 'h', 'basicLSTMCell'),
    d = de([p, c], 1),
    h = W(d, o),
    N = K(h, l),
    g = N.shape[0],
 ...
 */
function Hd(s, e) {
  const t = y(s, 'x', 'bitwiseAnd'),
    a = y(e, 'y', 'bitwiseAnd');
  if (!te(t.shape, a.shape))
    throw new Error(
      `BitwiseAnd: Tensors must have the same shape. x: ${t.shape}, y: ${a.shape}`,
    );
  if (t.dtype !== 'int32' || a.dtype !== 'int32')
    throw new Error(
      `BitwiseAnd: Only supports 'int32' values in tensor, found type of x: ${t.dtype} and type of y: ${a.dtype}`,
    );
  const r = { a: t, b: a };
 ...
 */
function Wd(s, e) {
  const t = y(s, 's0', 'broadcastArgs', 'int32'),
    a = y(e, 's1', 'broadcastArgs', 'int32');
  if (t.rank !== 1)
    throw new Error(
      `broadcastArgs(): first input must be a vector (rank=1). Has rank ${t.rank}`,
    );
  if (a.rank !== 1)
    throw new Error(
      `broadcastArgs(): second input must be a vector (rank=1). Has rank ${a.rank}`,
    );
  const r = { s0: t, s1: a };
...
function qd(s, e) {
  ...
  if (!Oi(t.shape, e))
    throw new Error(
      `EnsureShape: Shape of tensor ${t.shape} is not compatible with expected shape ${e}`,
    );
  return s;
}
...
function Gd(s, e, t = 'left') {
  const a = y(s, 'sortedSequence', 'searchSorted'),
    r = y(e, 'values', 'searchSorted'),
    n = a.shape[a.shape.length - 1],
    u = r.shape[r.shape.length - 1],
    o = v(a, [-1, n]),
    l = v(r, [-1, u]);
  if (o.rank < 2)
  ...
  if (o.shape[1] >= fe)
    throw new Error(
      `trailing dim_size must less than ${fe} for int32 output type, was ${o.shape[1]}`,
    );
  const p = {
      sortedSequence: o,
      values: l,
...
function Kd(s, e, t, a, r = !1) {
  const u = { x: y(s, 'x', 'maxPoolWithArgmax') },
    o = { filterSize: e, strides: t, pad: a, includeBatchInIndex: r },
    l = A.runKernel(ss, u, o);
...
function fn(s, e, { indexing: t = 'xy' } = {}) {
  ...
  return t === 'xy'
    ? ((a = v(a, [1, -1])),
      (r = v(r, [-1, 1])),
      [W(Y([u, 1], a.dtype), a), W(r, Y([1, n], r.dtype))])
    : ((a = v(a, [-1, 1])),
      (r = v(r, [1, -1])),
      [W(a, Y([1, u], a.dtype)), W(Y([n, 1], r.dtype), r)]);
}
function Jd(s, e, t, a) {
  const r = y(e, 'data', 'multiRNNCell'),
    n = xt(t, 'c', 'multiRNNCell'),
    u = xt(a, 'h', 'multiRNNCell');
  let o = r;
  const l = [];
  ...
  const p = [],
    m = [];
  for (let c = 0; c < l.length; c += 2) p.push(l[c]), m.push(l[c + 1]);
  return [p, m];
}
...
function Qd(s, e, t, a = !1) {
  const r = y(s, 'logits', 'multinomial'),
    n = r.size,
    u = r.rank;
  if (n < 2)
    throw new Error(
      `Error in multinomial: you need at least 2 outcomes, but got ${n}.`,
    );
  if (u > 2)
    throw new Error(`Rank of probabilities must be 1 or 2, but is ${u}`);
  t = t || Math.random();
  const l = { logits: u === 1 ? v(r, [1, -1]) : r },
    p = { numSamples: e, seed: t, normalized: a },
    m = A.runKernel(as, l, p);
  return u === 1 ? v(m, [m.size]) : m;
}
const gn = /* @__PURE__ */ S({ multinomial_: Qd });
function Xd(s, e) {
  const t = y(s, 'v1', 'outerProduct'),
    a = y(e, 'v2', 'outerProduct');
  w(
    t.rank === 1 && a.rank === 1,
    () =>
      `Error in outerProduct: inputs must be rank 1, but got ranks ${t.rank} and ${a.rank}.`,
  );
  const r = v(t, [-1, 1]),
    n = v(a, [1, -1]);
  return W(r, n);
...
function Zd(s, e, t = 0) {
  return (
    w(e.length === 2, () => 'Invalid number of paddings. Must be length of 2.'),
    ae(s, [e], t)
  );
}
...
function Yd(s, e, t = 0) {
  return (
    w(
      e.length === 2 && e[0].length === 2 && e[1].length === 2,
 ...
 */
function th(s, e, t, a) {
  const r = s.map((m, c) => y(m, `tensors${c}`, 'raggedGather', 'int32')),
    n = y(e, 'paramsDenseValues', 'raggedGather'),
    u = y(t, 'indices', 'raggedGather', 'int32'),
    o = {
      paramsNestedSplits: r,
      paramsDenseValues: n,
      indices: u,
    },
    l = { outputRaggedRank: a },
    p = A.runKernel(rs, o, l);
  return {
 ...
 */
function sh(s, e, t) {
  const a = y(s, 'starts', 'raggedRange'),
    r = y(e, 'limits', 'raggedRange', a.dtype),
    n = y(t, 'deltas', 'raggedRange', a.dtype),
    u = {
      starts: a,
      limits: r,
      deltas: n,
...
function ah(s, e, t, a, r) {
  const n = y(s, 'shape', 'raggedTensorToTensor', 'int32'),
    u = y(e, 'values', 'raggedTensorToTensor'),
    o = y(t, 'defaultValue', 'raggedTensorToTensor', u.dtype),
    l = a.map((c, d) => y(c, `tensors${d}`, 'raggedTensorToTensor', 'int32')),
    p = {
      shape: n,
      values: u,
      defaultValue: o,
...
function rh(s, e, t) {
  ...
  const a = pe(s);
  let r = null;
  if (t == null || t === 'float32') r = new Float32Array(a);
  else if (t === 'int32') r = new Int32Array(a);
  else if (t === 'bool') r = new Uint8Array(a);
  else throw new Error(`Unknown data type ${t}`);
  for (let n = 0; n < a; n++) r[n] = e();
...
function je(s, e, t) {
  ...
  if (((Z(s) || Z(e)) && (a = !1), Z(s) && Z(e) && (a = !0), a)) {
    ...
    if (u !== o)
      throw new Error(
        `Arrays are of different type. Actual: ${u}. Expected: ${o}`,
      );
  }
  if (Array.isArray(s) && Array.isArray(e)) {
    ...
    if (!te(u, o))
      throw new Error(
        `Arrays have different shapes. Actual: [${u}]. Expected: [${o}]`,
      );
  }
  const r = Z(s) ? s : Lt(s),
    n = Z(e) ? e : Lt(e);
...
function uh(s, e) {
  const t =
    typeof e == 'string' || typeof e == 'number' || typeof e == 'boolean'
      ? [e]
      : e;
  return he(s) || he(s[0]) || he(e) || he(e[0])
    ? je(s, t, (a, r) => a == r)
    : je(s, e, (a, r) => Nt(a, r, 0));
}
function lh(s, e, t) {
...
function Nt(s, e, t) {
  return !isFinite(s) && !isFinite(e)
    ? !0
    : !(isNaN(s) || isNaN(e) || Math.abs(s - e) > t);
}
function ph(s, e, t) {
...
function mh(s, e) {
  const t = new Float32Array(s),
    a = new Float32Array(e);
  if (t.length !== a.length)
    throw new Error(
      `Expected ArrayBuffer to be of length ${a.length}, but it was ${t.length}`,
    );
  for (let r = 0; r < a.length; r++)
    if (t[r] !== a[r])
      throw new Error(
        `Expected ArrayBuffer value at ${r} to be ${a[r]} but got ${t[r]} instead`,
      );
}
function kn(s) {
...
const hh = /* @__PURE__ */ Object.freeze(
...
function fh(s, e, t = 1, a = 'float32', r) {
  ...
  const n = new Ai(e, t, a, r),
    u = Ye(s, a);
  for (let o = 0; o < u.values.length; o++) u.values[o] = n.nextValue();
  return u.toTensor();
}
...
function Nh(s, e) {
  ...
  return (
    w(
      t.rank === 2,
      () => `Error in reverse2D: x must be rank 2 but got rank ${t.rank}.`,
    ),
    re(t, e)
  );
}
...
function wh(s, e) {
  ...
  return (
    w(
      t.rank === 3,
      () => `Error in reverse3D: x must be rank 3 but got rank ${t.rank}.`,
    ),
    re(t, e)
  );
}
...
function Th(s, e) {
  ...
  return (
    w(
      t.rank === 4,
      () => `Error in reverse4D: x must be rank 4 but got rank ${t.rank}.`,
    ),
    re(t, e)
  );
}
...
async function Sh(s, e) {
  const t = y(s, 'x', 'setdiff1d'),
    a = y(e, 'y', 'setdiff1d');
  w(
    t.dtype === a.dtype,
    () =>
      `x and y should have the same dtype, but got x (${t.dtype}) and y (${a.dtype}).`,
  ),
    w(t.rank === 1, () => `x should be 1D tensor, but got x (${t.shape}).`),
    w(a.rank === 1, () => `y should be 1D tensor, but got y (${a.shape}).`);
  const r = await t.data(),
    n = await a.data(),
    u = new Set(n);
  let o = 0;
  for (let m = 0; m < r.length; m++) u.has(r[m]) || o++;
  const l = new Fe([o], t.dtype),
    p = new Fe([o], 'int32');
 ...
 */
function vh(s, e, t) {
  const a = y(s, 'tensor', 'tensorScatterupdate'),
    r = y(e, 'indices', 'tensorScatterupdate', 'int32'),
    n = y(t, 'updates', 'tensorScatterupdate');
  if ((os(n, r, a.shape), a.dtype !== n.dtype))
    throw new Error(
      `tensor and updates must have the same dtype, instead they are ${a.dtype} and ${n.dtype}.`,
    );
  const u = {
      tensor: a,
      indices: r,
 ...
 */
async function Oh(s) {
  const e = y(s, 'condition', 'whereAsync', 'bool'),
    t = await e.data(),
    a = ls(e.shape, t);
...
async function _h(s, e, t) {
  const a = y(s, 'tensor', 'boolMask'),
    r = y(e, 'mask', 'boolMask', 'bool'),
    n = t ?? 0,
    u = r.rank,
    o = a.shape;
  w(u > 0, () => 'mask cannot be scalar'),
    ps(
      o.slice(n, n + u),
      r.shape,
  ...
  let l = 1;
  for (let g = n; g < n + u; g++) l *= o[g];
  const p = o.slice(0, n).concat([l], o.slice(n + u)),
    m = v(a, p),
    c = v(r, [-1]),
    d = await wt(c),
    h = at(d, [1]),
...
function Ah(s, e, t, a, r = !0) {
  const n = y(s, 'v', 'movingAverage'),
    u = y(e, 'x', 'movingAverage'),
    o = y(t, 'decay', 'movingAverage');
...
function Eh(s, e, t) {
  $e(t);
  const a = y(s, 'indices', 'scatterND', 'int32'),
    r = y(e, 'updates', 'scatterND');
  os(r, a, t);
  const n = { indices: a, updates: r },
    u = { shape: t };
...
function kh(s, e, t, a) {
  if (s.dtype !== 'int32')
    throw new Error(
      `tf.sparseToDense() expects the indices to be int32 type, but the dtype was ${s.dtype}.`,
    );
  if (s.rank > 2)
    throw new Error(
      `sparseIndices should be a scalar, vector, or matrix, but got shape ${s.shape}.`,
    );
  const r = s.rank > 0 ? s.shape[0] : 1,
    n = s.rank > 1 ? s.shape[1] : 1;
  if (t.length !== n)
    throw new Error(
      `outputShape has incorrect number of elements:, ${t.length}, should be: ${n}.`,
    );
  const u = e.size;
  if (!(e.rank === 0 || (e.rank === 1 && u === r)))
    throw new Error(
      `sparseValues has incorrect shape ${e.shape}, should be [] or [${r}]`,
    );
  if (e.dtype !== a.dtype)
...
function Ih(s, e, t, a = 0) {
  $e(t);
  const r = y(s, 'sparseIndices', 'sparseToDense', 'int32'),
    n = y(e, 'sparseValues', 'sparseToDense', 'string_or_numeric'),
    u = y(a, 'defaultValue', 'sparseToDense', n.dtype);
  kh(r, n, t, u);
  const o = {
      sparseIndices: r,
      sparseValues: n,
 ...
 */
function $h(s, e) {
  const t = y(e, 'indices', 'gatherND', 'int32'),
    r = { params: y(s, 'x', 'gatherND', 'string_or_numeric'), indices: t };
...
async function Dh(s, e, t = 1) {
  const a = y(s, 'predictions', 'inTopK'),
    r = y(e, 'targets', 'inTopK');
  w(
    a.rank > 1,
    () =>
      `inTopK() expects the predictions to be of rank 2 or higher, but got ${a.rank}`,
  ),
    w(
      a.rank - 1 === r.rank,
      () =>
        `predictions rank should be 1 larger than targets rank, but got predictions rank ${a.rank} and targets rank ${r.rank}`,
    ),
    ps(
  ...
  w(
    t > 0 && t <= n,
    () =>
      `'k' passed to inTopK() must be > 0 && <= the predictions last dimension (${n}), but got ${t}`,
  );
  const u = await a.data(),
    o = await r.data(),
    [l, p] = [u.length / n, n],
    m = ki('bool', l);
  for (let c = 0; c < l; c++) {
    const d = c * p,
      h = u.subarray(d, d + p),
      N = [];
    for (let g = 0; g < h.length; g++) N.push({ value: h[g], index: g });
...
function Ch({
  ...
  const c = y(s, 'x', 'depthwiseConv2d', 'float32'),
    d = y(e, 'filter', 'depthwiseConv2d', 'float32');
  let h = c,
    N = !1;
  c.rank === 3 &&
    ((N = !0), (h = v(c, [1, c.shape[0], c.shape[1], c.shape[2]]))),
    w(
      h.rank === 4,
      () =>
        `Error in fused depthwiseConv2d: input must be rank 4, but got rank ${h.rank}.`,
    ),
    w(
      d.rank === 4,
      () =>
    ...
    w(
      h.shape[3] === d.shape[2],
      () =>
        `Error in fused depthwiseConv2d: number of input channels (${h.shape[3]}) must match the inChannels dimension in filter ${d.shape[2]}.`,
    ),
    n == null && (n = [1, 1]),
    w(
      Di(t, n),
      () =>
        `Error in fused depthwiseConv2d: Either strides or dilations must be 1. Got strides ${t} and dilations '${n}'`,
    ),
    Ci('fused depthwiseConv2d', a, u);
  const g = zi(
    h.shape,
    d.shape,
    t,
  ...
  let f;
  o != null &&
    ((f = y(o, 'bias', 'fused conv2d')),
    ([f] = xi(f, c)),
    Li(g.outShape, f.shape));
  let b;
  ...
  const O = (I, D) => {
      w(
        Pi(n),
        () =>
          `Error in gradient of fused depthwiseConv2d: dilation rates greater than 1 are not yet supported. Got dilations '${n}'`,
      );
      const [C, X, F, j] = D,
        ze = Fi(I, F, l),
        $t = Vi(X.shape, ze, C, t, a, n, u),
        Dt = Ri(X, ze, C.shape, t, a, n, u);
      if (j != null) {
        const wi = ji(f, ze);
        return [$t, Dt, wi];
      }
  ...
  return o == null
    ? Ve((D, C, X) => {
        ...
        return (
          X([C, D, F]),
          N && (F = v(F, [F.shape[1], F.shape[2], F.shape[3]])),
          { value: F, gradFunc: O }
        );
      })(h, d)
    : Ve((D, C, X, F) => {
        ...
        return (
          F([C, D, j, X]),
          N && (j = v(j, [j.shape[1], j.shape[2], j.shape[3]])),
          { value: j, gradFunc: O }
        );
      })(h, d, f);
}
...
class J {
  constructor(e) {
    ...
    e.startsWith(J.URL_SCHEME) && (e = e.slice(J.URL_SCHEME.length)),
      (e == null || e.length === 0) && (e = xh),
      (this.modelJsonFileName = e + Lh),
      (this.weightDataFileName = e + Ph);
  }
  async save(e) {
      ...
      );
    {
      ...
      if (
        ((o.download = this.modelJsonFileName),
        (o.href = u),
        await Ft(() => o.dispatchEvent(new MouseEvent('click'))),
        e.weightData != null)
      ) {
        const l =
        ...
        (l.download = this.weightDataFileName),
          (l.href = a),
          await Ft(() => l.dispatchEvent(new MouseEvent('click')));
      }
...
class Fh {
  ...
  loadWeights(e) {
    const t = [],
      a = [];
    for (const u of e) t.push(...u.weights), a.push(...u.paths);
    const r = this.checkManifestAndWeightFiles(e),
      n = a.map((u) => this.loadWeightsFile(u, r[u]));
  ...
  checkManifestAndWeightFiles(e) {
    const t = [],
      a = this.weightsFiles.map((n) => Pt(n.name)),
      r = {};
    for (const n of e)
      n.paths.forEach((u) => {
        const o = Pt(u);
        if (t.indexOf(o) !== -1)
          throw new Error(
            `Duplicate file basename found in weights manifest: '${o}'`,
          );
...
const Vh = (s) =>
  P().getBool('IS_BROWSER') && !Array.isArray(s) && s.startsWith(J.URL_SCHEME)
    ? Rh(s.slice(J.URL_SCHEME.length))
    : null;
...
function Ee(s, e, t, a) {
  return arguments.length === 1
    ? s.modelTopology != null || s.weightSpecs != null
      ? new xe(s)
      : (console.warn(
 ...
 */
function qh(s, e, t) {
  const a = y(s, 'labels', 'confusionMatrix'),
    r = y(e, 'predictions', 'confusionMatrix');
  w(
    t == null || (t > 0 && Number.isInteger(t)),
    () => `If provided, numClasses must be a positive integer, but got ${t}`,
  ),
    w(
      a.rank === 1,
      () => `Expected the rank of labels to be 1, but got ${a.rank}`,
    ),
    w(
      r.rank === 1,
      () => `Expected the rank of predictions to be 1, but got ${r.rank}`,
    ),
    w(
      a.shape[0] === r.shape[0],
      () =>
        `Mismatch in the number of examples: ${a.shape[0]} vs. ${r.shape[0]}. Labels and predictions should have the same number of elements.`,
    ),
    w(
      t > 0 && Number.isInteger(t),
      () => `numClasses is required to be a positive integer, but got ${t}`,
    );
  const n = Oe(ee(a, 'int32'), t),
    u = Oe(ee(r, 'int32'), t),
    o = ut(n),
    l = W(o, u);
  return ee(l, 'int32');
 ...
 * =============================================================================
 */
const Kh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      confusionMatrix: Gh,
 ...
 * =============================================================================
 */
const Jh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
...
const Mh = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      maxNorm: Qh,
...
class ai extends si {
  constructor(e) {
    ...
    (this.monitor = e.monitor || 'val_loss'),
      (this.minDelta = Math.abs(e.minDelta || 0)),
      (this.patience = e.patience || 0),
      (this.verbose = e.verbose || 0),
      (this.mode = e.mode || 'auto'),
      (this.baseline = e.baseline),
      ['auto', 'min', 'max'].indexOf(this.mode) === -1 &&
        (console.warn(
      ...
      this.mode === 'min'
        ...
        : this.mode === 'max'
          ? (this.monitorFunc = Vt)
          : this.monitor.indexOf('acc') !== -1
            ? (this.monitorFunc = Vt)
            : (this.monitorFunc = ye),
      this.monitorFunc === ye && (this.minDelta *= -1);
  }
  async onTrainBegin(e) {
    (this.wait = 0),
      ...
      this.baseline != null
        ...
        : (this.best = this.monitorFunc === ye ? 1 / 0 : -1 / 0);
  }
  async onEpochEnd(e, t) {
    await il(t);
    const a = this.getMonitorValue(t);
    a != null &&
      (this.monitorFunc(a - this.minDelta, this.best)
        ? ((this.best = a), (this.wait = 0))
        : (this.wait++,
          this.wait >= this.patience &&
            ((this.stoppedEpoch = e), (this.model.stopTraining = !0))));
  }
  async onTrainEnd(e) {
    this.stoppedEpoch > 0 &&
      this.verbose &&
  ...
  getMonitorValue(e) {
    ...
    return (
      t == null &&
        console.warn(
          `Metric for EarlyStopping ${this.monitor} is not available. Available metrics are: ${Object.keys(e)}`,
        ),
      t
    );
  }
...
function i(s, e, t, a, r) {
  ...
  if (n && n.inputIndexStart !== void 0) {
    const o = n.inputIndexStart,
      l =
        n.inputIndexEnd === 0
          ? void 0
          : n.inputIndexEnd === void 0
            ? o + 1
            : n.inputIndexEnd,
      p = o < 0 ? e.inputNames.length + o : o;
    if (n.type === 'tensor') return E(e.inputNames[p], t, a, r);
    if (n.type === 'tensors') {
      ...
      return e.inputNames
        ...
        .filter((N, g) => {
          var f;
          return (
            ((f = d[g]) === null || f === void 0 ? void 0 : f.op) !== 'NoOp'
          );
        })
        .map((N) => E(N, t, a, r));
    }
    const m = E(e.inputNames[p], t, a, r),
      c = m.dataSync();
...
function B(s, e) {
  const [t, a, r] = $(s, e);
  return [ke(t, e && e.currentContextId), a, r];
}
function ke(s, e) {
  return e ? `${s}-${e}` : s;
}
function $(s, e) {
  if (s === '') return ['', 0, void 0];
  ...
  const a = s.split(':');
  let r;
  if (a.length === 1) r = [s, 0, void 0];
  else {
    const n = a[0],
      u = a.length === 3 ? a[1] : void 0,
...
function we(s, e, t) {
  ...
  if (a === 'explicit') {
    ...
    for (let n = 0; n < 4; n++) (r[n][0] = a[n * 2]), (r[n][1] = a[n * 2 + 1]);
    return r;
  }
  return a;
}
...
class jt {
  ...
  transformGraph(e, t = {}) {
    const a = e.node,
      ...
      o = a.reduce(
        (g, f) => (
          (g[f.name] = this.mapNode(f)),
          f.op.startsWith('Placeholder')
            ? r.push(g[f.name])
            : f.op === 'Const'
              ? n.push(g[f.name])
              : (f.input == null || f.input.length === 0) && u.push(g[f.name]),
          g
        ),
        {},
      );
    ...
    e.library != null &&
      ...
      (h = e.library.function.reduce(
        (g, f) => ((g[f.signature.name] = this.mapFunction(f)), g),
        {},
      ));
    const N = {
      nodes: o,
    ...
    return (
      ...
      t.attrs != null &&
        (a.attrParams = t.attrs.reduce((r, n) => {
          ...
          switch (n.type) {
            case 'string':
              (o = Be(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Be(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'string[]':
              (o = Je(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Je(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'number':
              (o = We(e.attr, n.tfName, n.defaultValue || 0)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = We(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'number[]':
              (o = Ke(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Ke(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'bool':
              (o = He(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = He(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'bool[]':
              (o = Xe(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Xe(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'shape':
              (o = Ge(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Ge(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'shape[]':
              (o = Qe(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Qe(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'dtype':
              (o = Ue(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Ue(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'dtype[]':
              (o = qe(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
              ...
              break;
            case 'func':
              (o = Bt(e.attr, n.tfName, n.defaultValue)),
                o === void 0 &&
                  n.tfDeprecatedName &&
                  (o = Bt(e.attr, n.tfDeprecatedName, n.defaultValue));
              break;
            case 'tensor':
            case 'tensors':
              break;
  ...
  mapFunction(e) {
    ...
    t != null &&
      (n = t.reduce(
        (c, d) => (
          (c[d.name] = this.mapNode(d)),
          d.op === 'Const' && r.push(c[d.name]),
          c
        ),
        {},
      ));
...
function qg(s) {
  const e = P().global;
  if (typeof e.atob < 'u') return e.atob(s);
  if (typeof Buffer < 'u') return new Buffer(s, 'base64').toString();
  throw new Error(
...
function ii(s) {
  if (!s.unknownRank)
    return s.dim != null
      ? s.dim.map((e) =>
          typeof e.size == 'number' ? e.size : parseInt(e.size, 10),
        )
      : [];
}
function Ge(s, e, t) {
...
function Ke(s, e, t) {
  const a = s[e];
  return a
    ? ((a.list.f && a.list.f.length ? a.list.f : a.list.i) || []).map((r) =>
...
class Gg {
  ...
  getAttr(e, t) {
    ...
    if (a.tensor != null) return E(e, this.tensorMap, this.context);
    if (a.i != null || a.f != null) return We(this.node.rawAttrs, e, t);
    if (a.s != null) return Be(this.node.rawAttrs, e, t);
    if (a.b != null) return He(this.node.rawAttrs, e, t);
    if (a.shape != null) return Ge(this.node.rawAttrs, e, t);
    if (a.type != null) return Ue(this.node.rawAttrs, e, t);
    if (a.list != null) {
      if (a.list.i != null || a.list.f != null)
        return Ke(this.node.rawAttrs, e, t);
      if (a.list.s != null) return Je(this.node.rawAttrs, e, t);
      if (a.list.shape != null) return Qe(this.node.rawAttrs, e, t);
      if (a.list.b != null) return Xe(this.node.rawAttrs, e, t);
      if (a.list.type != null) return qe(this.node.rawAttrs, e, t);
    }
    return t;
  }
}
  ...
  switch (s.op) {
    ...
    case 'ClipByValue':
      return [
        a.clipByValue(
          i('x', s, e, t),
          i('clipValueMin', s, e, t),
          i('clipValueMax', s, e, t),
        ),
      ];
    case 'Relu6':
...
function ie(s, e, t) {
  ...
  if (r && e.length === 0)
    throw new Error(
      `Tried to calculate elements of an empty list with non-fully-defined elementShape: ${a}`,
    );
  if (
    (r &&
      e.forEach((n) => {
...
class Qg {
  ...
  gather(e, t) {
    ...
    if (e.length === 0) return q([], [0].concat(this.elementShape));
    const a = this.readMany(e);
    return (
      x(this.elementShape, a[0].shape, 'TensorArray shape mismatch: '), se(a, 0)
    );
  }
  /**
  ...
  concat(e) {
    ...
    if (this.size() === 0) return q([], [0].concat(this.elementShape));
    const t = [];
  ...
  split(e, t) {
    ...
    const n = a === 0 ? 0 : t.size / a,
      u = [];
    L(() => {
      t = v(t, [1, a, n]);
      for (let l = 0; l < e.length; ++l) {
        const m = [0, l === 0 ? 0 : r[l - 1], 0],
          c = [1, e[l], n];
    ...
    const o = [];
    for (let l = 0; l < e.length; l++) o[l] = l;
    this.writeMany(o, u);
  }
}
/**
...
class Q {
    ...
    (this.tensors = e),
      ...
      e != null &&
        e.forEach((n) => {
          if (a !== n.dtype)
            throw new Error(
              `Invalid data types; op elements ${a}, but list elements ${n.dtype}`,
            );
  ...
  popBack(e, t) {
    ...
    const a = ie(this.elementShape, this.tensors, e),
      r = this.tensors.pop();
  ...
  pushBack(e) {
    ...
    if (
      (x(e.shape, this.elementShape, 'TensorList shape mismatch: '),
  ...
  setItem(e, t) {
    ...
    x(this.elementShape, t.shape, 'TensorList shape mismatch: '),
      V(t),
      this.tensors[e] != null && (this.tensors[e].kept = !1),
      (this.tensors[e] = t);
  }
  /**
  ...
  gather(e, t, a) {
    ...
    x(this.elementShape, a, 'TensorList shape mismatch: '),
...
function Xg(s, e, t) {
  ...
  if (s.shape.length < 1)
    throw new Error(
      `Tensor must be at least a vector, but saw shape: ${s.shape}`,
    );
  if (s.dtype !== t)
    throw new Error(
      `Invalid data types; op elements ${s.dtype}, but list elements ${t}`,
    );
...
function Yg(s, e, t, a) {
  if (e.length !== s.shape[0])
    throw new Error(
      `Expected len(indices) == tensor.shape[0], but saw: ${e.length} vs. ${s.shape[0]}`,
    );
  const r = Math.max(...e);
  if (a != null && a !== -1 && r >= a)
    throw new Error(`Max index must be < array size (${r}  vs. ${a})`);
  const n = new Q([], t, s.dtype, a),
    u = ne(s, 0);
  return (
    e.forEach((o, l) => {
      n.setItem(o, u[l]);
...
function Mg(s, e, t) {
  ...
  for (let m = 0; m < l.length; m++) p.setItem(m, l[m]);
  return p;
}
/**
 * @license
...
const eb = async (s, e, t) => {
  switch (s.op) {
    case 'If':
    case 'StatelessIf': {
      const a = i('thenBranch', s, e, t),
        r = i('elseBranch', s, e, t),
        n = i('cond', s, e, t),
        u = i('args', s, e, t);
      return (await n.data())[0]
        ? t.functionMap[a].executeFunctionAsync(
            u,
            t.tensorArrayMap,
            t.tensorListMap,
          )
        : t.functionMap[r].executeFunctionAsync(
            u,
            t.tensorArrayMap,
            t.tensorListMap,
          );
    ...
    case 'While':
    case 'StatelessWhile': {
      const a = i('body', s, e, t),
        r = i('cond', s, e, t),
        n = i('args', s, e, t),
        u = await t.functionMap[r].executeFunctionAsync(
          n,
          t.tensorArrayMap,
          t.tensorListMap,
        ),
      ...
      for (; l[0]; ) {
        const m = p;
        p = await t.functionMap[a].executeFunctionAsync(
          p,
          t.tensorArrayMap,
          t.tensorListMap,
        );
        ...
        const d = await t.functionMap[r].executeFunctionAsync(
          p,
          t.tensorArrayMap,
          t.tensorListMap,
        );
    ...
    case 'Switch': {
      ...
      let r = i('data', s, e, t);
      return (
        r.kept || (r = H(r)), (await a.data())[0] ? [void 0, r] : [r, void 0]
      );
    }
    case 'Merge': {
    ...
    case 'TensorArrayV3': {
      const a = i('size', s, e, t),
        r = i('dtype', s, e, t),
        n = i('elementShape', s, e, t),
        u = i('dynamicSize', s, e, t),
        o = i('clearAfterRead', s, e, t),
        l = i('identicalElementShapes', s, e, t),
        p = i('name', s, e, t),
        m = new Qg(p, r, a, n, l, u, o);
      return t.addTensorArray(m), [m.idTensor, R(1)];
    }
    case 'TensorArrayWriteV3': {
      const a = i('tensorArrayId', s, e, t),
        r = i('index', s, e, t),
        n = i('tensor', s, e, t),
        u = t.getTensorArray(a.id);
    ...
    case 'TensorListSetItem': {
      const a = i('tensorListId', s, e, t),
        r = i('index', s, e, t),
        n = i('tensor', s, e, t),
        u = t.getTensorList(a.id);
    ...
    case 'TensorListGetItem': {
      const a = i('tensorListId', s, e, t),
        r = i('index', s, e, t),
        n = i('elementShape', s, e, t),
        u = i('elementDType', s, e, t);
      return [t.getTensorList(a.id).getItem(r, n, u)];
    }
    case 'TensorListScatterV2':
    case 'TensorListScatter': {
      const a = i('indices', s, e, t),
        r = i('tensor', s, e, t),
        n = i('elementShape', s, e, t),
        u = i('numElements', s, e, t),
        o = Yg(r, a, n, u);
      return t.addTensorList(o), [o.idTensor];
    }
    case 'TensorListReserve':
    case 'EmptyTensorList': {
      const a = i('elementShape', s, e, t),
        r = i('elementDType', s, e, t);
      let n;
      s.op === 'TensorListReserve'
        ? (n = 'numElements')
        : (n = 'maxNumElements');
      const u = i(n, s, e, t),
        o = s.op === 'TensorListReserve' ? -1 : u,
        l = Zg(a, r, u, o);
    ...
    case 'TensorListStack': {
      const a = i('tensorListId', s, e, t),
        r = i('elementShape', s, e, t),
        n = i('elementDType', s, e, t),
        u = i('numElements', s, e, t);
    ...
    case 'TensorListConcatV2': {
      const a = i('tensorListId', s, e, t),
        r = t.getTensorList(a.id),
        n = i('dtype', s, e, t),
        u = i('elementShape', s, e, t);
      return [r.concat(n, u)];
    }
    case 'TensorListPushBack': {
      const a = i('tensorListId', s, e, t),
        r = i('tensor', s, e, t),
        n = t.getTensorList(a.id);
    ...
    case 'TensorListResize': {
      const a = i('tensorListId', s, e, t),
        r = i('size', s, e, t),
        u = t.getTensorList(a.id).resize(r);
      return t.addTensorList(u), [u.idTensor];
    }
    default:
      throw TypeError(`Node type ${s.op} is not implemented`);
...
function Wt(s, e, t) {
  ...
  const m = i('strides', s, e, t),
    c = we(s, e, t),
    d = i('dataFormat', s, e, t).toUpperCase(),
    h = i('dilations', s, e, t);
...
const tb = (s, e, t, a = k) => {
  switch (s.op) {
    case 'Conv1D': {
      const r = i('stride', s, e, t),
        n = i('pad', s, e, t),
        u = i('dataFormat', s, e, t).toUpperCase(),
        o = i('dilation', s, e, t);
      return [a.conv1d(i('x', s, e, t), i('filter', s, e, t), r, n, u, o)];
    }
    case 'Conv2D': {
      const r = i('strides', s, e, t),
        n = we(s, e, t),
        u = i('dataFormat', s, e, t).toUpperCase(),
        o = i('dilations', s, e, t);
      return [
        a.conv2d(i('x', s, e, t), i('filter', s, e, t), [r[1], r[2]], n, u, [
          o[1],
          o[2],
        ]),
      ];
    ...
    case 'DepthwiseConv2d': {
      const r = i('strides', s, e, t),
        n = we(s, e, t),
        u = i('dilations', s, e, t),
        o = i('dataFormat', s, e, t).toUpperCase();
      return [
        a.depthwiseConv2d(
          i('input', s, e, t),
          i('filter', s, e, t),
    ...
    case 'MaxPoolWithArgmax': {
      const r = i('strides', s, e, t),
        n = i('pad', s, e, t),
        u = i('kernelSize', s, e, t),
        o = i('includeBatchInIndex', s, e, t),
        { result: l, indexes: p } = a.maxPoolWithArgmax(
          i('x', s, e, t),
          [u[1], u[2]],
          [r[1], r[2]],
          n,
    ...
    case 'AvgPool3D': {
      const r = i('strides', s, e, t),
        ...
        u = i('kernelSize', s, e, t);
      return [
        a.avgPool3d(i('x', s, e, t), [u[1], u[2], u[3]], [r[1], r[2], r[3]], n),
      ];
    }
    case 'MaxPool3D': {
      const r = i('strides', s, e, t),
        ...
        u = i('kernelSize', s, e, t);
      return [
        a.maxPool3d(i('x', s, e, t), [u[1], u[2], u[3]], [r[1], r[2], r[3]], n),
      ];
    }
    case 'Dilation2D': {
      const r = i('strides', s, e, t),
...
const sb = (s, e, t, a = k) => {
  switch (s.op) {
    case 'Fill': {
      const r = i('shape', s, e, t),
        n = i('dtype', s, e, t),
        u = i('value', s, e, t);
      return [a.fill(r, u, n)];
    }
    case 'LinSpace': {
      const r = i('start', s, e, t),
        n = i('stop', s, e, t),
        u = i('num', s, e, t);
      return [a.linspace(r, n, u)];
    }
    case 'Multinomial': {
      const r = i('logits', s, e, t),
        n = i('numSamples', s, e, t),
        u = i('seed', s, e, t);
      return [a.multinomial(r, n, u)];
    }
    case 'OneHot': {
      const r = i('indices', s, e, t),
        n = i('depth', s, e, t),
        u = i('onValue', s, e, t),
        o = i('offValue', s, e, t),
        l = i('dtype', s, e, t);
 ...
 */
function Le(s, e, t) {
  const a = i('boxes', s, e, t),
    r = i('scores', s, e, t),
    n = i('maxOutputSize', s, e, t),
    u = i('iouThreshold', s, e, t),
    o = i('scoreThreshold', s, e, t),
    l = i('softNmsSigma', s, e, t);
  return {
    boxes: a,
    scores: r,
    maxOutputSize: n,
  ...
  switch (s.op) {
    case 'NonMaxSuppressionV5': {
      const {
        ...
        c = await r.image.nonMaxSuppressionWithScoreAsync(n, u, o, l, p, m);
    ...
    case 'NonMaxSuppressionV4': {
      const {
        ...
        m = i('padToMaxOutputSize', s, e, t),
        c = await r.image.nonMaxSuppressionPaddedAsync(n, u, o, l, p, m);
    ...
    case 'Where': {
      const n = r.cast(i('condition', s, e, t), 'bool'),
        u = [await r.whereAsync(n)];
      return n.dispose(), u;
    }
    case 'ListDiff':
...
const rb = (s, e, t, a = k) => {
  switch (s.op) {
    case 'LowerBound': {
      const r = i('sortedSequence', s, e, t),
        n = i('values', s, e, t);
    ...
    return (
      ...
      L(() => {
        ...
        w(
          n === u,
          () =>
            `The number of elements doesn't match, keys has ${n} elements, the values has ${u} elements.`,
        );
        for (let o = 0; o < n; o++) {
          const l = a[o],
            p = r[o];
...
const ob = async (s, e, t, a) => {
  switch (s.op) {
    ...
    case 'HashTableV2': {
      ...
      if (r != null) return [r];
      {
        const n = i('keyDType', s, e, t),
          u = i('valueDType', s, e, t),
          o = new ib(n, u);
...
const ub = (s, e, t, a = k) => {
  switch (s.op) {
    case 'ResizeBilinear': {
      const r = i('images', s, e, t),
        n = i('size', s, e, t),
        u = i('alignCorners', s, e, t),
        o = i('halfPixelCenters', s, e, t);
    ...
    case 'CropAndResize': {
      const r = i('image', s, e, t),
        n = i('boxes', s, e, t),
        u = i('boxInd', s, e, t),
        o = i('cropSize', s, e, t),
        l = i('method', s, e, t),
        p = i('extrapolationValue', s, e, t);
      return [a.image.cropAndResize(r, n, u, o, l, p)];
    }
    case 'ImageProjectiveTransformV3': {
      const r = i('images', s, e, t),
        n = i('transforms', s, e, t),
        u = i('outputShape', s, e, t),
        o = i('fillValue', s, e, t),
        l = i('interpolation', s, e, t),
        p = i('fillMode', s, e, t);
...
const lb = (s, e, t, a = k) => {
  switch (s.op) {
    ...
    case 'SelectV2':
      return [
        a.where(i('condition', s, e, t), i('a', s, e, t), i('b', s, e, t)),
      ];
    case 'BitwiseAnd':
...
const pb = (s, e, t, a = k) => {
  switch (s.op) {
    ...
    case '_FusedMatMul':
      const [r, n] = i('fusedOps', s, e, t),
        u = r === 'biasadd',
        o = n === 'prelu',
        l = i('numArgs', s, e, t),
        p = i('leakyreluAlpha', s, e, t);
      if (u) {
        if (o && l !== 2)
          throw new Error(
...
const cb = (s, e, t, a = k) => {
  switch (s.op) {
    case 'RaggedGather': {
      const { outputNestedSplits: r, outputDenseValues: n } = a.raggedGather(
        i('paramsNestedSplits', s, e, t),
        i('paramsDenseValues', s, e, t),
        i('indices', s, e, t),
        i('outputRaggedRank', s, e, t),
      );
      return r.concat(n);
    }
    case 'RaggedRange': {
      const { rtNestedSplits: r, rtDenseValues: n } = a.raggedRange(
        i('starts', s, e, t),
        i('limits', s, e, t),
        i('splits', s, e, t),
      );
    ...
    case 'RaggedTensorToTensor':
      return [
        a.raggedTensorToTensor(
          i('shape', s, e, t),
          i('values', s, e, t),
          i('defaultValue', s, e, t),
          i('rowPartitionTensors', s, e, t),
          i('rowPartitionTypes', s, e, t),
        ),
      ];
    default:
      throw TypeError(`Node type ${s.op} is not implemented`);
...
const hb = (s, e, t, a = k) => {
  switch (s.op) {
    ...
    case 'Reverse': {
      const r = i('dims', s, e, t),
        n = [];
      for (let o = 0; o < r.length; o++) r[o] && n.push(o);
      const u = i('x', s, e, t);
    ...
    case 'StridedSlice': {
      const r = i('begin', s, e, t),
        ...
        o = i('beginMask', s, e, t),
        l = i('endMask', s, e, t),
        p = i('ellipsisMask', s, e, t),
        m = i('newAxisMask', s, e, t),
        c = i('shrinkAxisMask', s, e, t),
        d = i('x', s, e, t);
    ...
    case 'SparseToDense': {
      const r = i('sparseIndices', s, e, t),
        n = i('outputShape', s, e, t),
        u = i('sparseValues', s, e, t),
        o = i('defaultValue', s, e, t);
      return [
        a.sparseToDense(r, u, n, u.dtype === o.dtype ? o : a.cast(o, u.dtype)),
      ];
    }
...
const fb = (s, e, t, a = k) => {
  switch (s.op) {
    ...
    case 'SparseReshape': {
      const { outputIndices: r, outputShape: n } = a.sparse.sparseReshape(
        i('inputIndices', s, e, t),
        i('inputShape', s, e, t),
        i('newShape', s, e, t),
      );
      return [r, n];
...
const gb = (s, e, t, a = k) => {
  switch (s.op) {
    case 'StaticRegexReplace':
      return [
        a.string.staticRegexReplace(
          i('input', s, e, t),
          i('pattern', s, e, t),
          i('rewrite', s, e, t),
          i('replaceGlobal', s, e, t),
        ),
      ];
    case 'StringNGrams': {
      const { nGrams: r, nGramsSplits: n } = a.string.stringNGrams(
        ...
        i('rightPad', s, e, t),
        i('padWidth', s, e, t),
        i('preserveShortSequences', s, e, t),
      );
      return [r, n];
    }
    case 'StringSplit': {
    ...
    case 'StringToHashBucketFast':
      return [
        a.string.stringToHashBucketFast(
          i('input', s, e, t),
          i('numBuckets', s, e, t),
        ),
      ];
...
const bb = (s, e, t, a = k) => {
  switch (s.op) {
    ...
    case 'MirrorPad':
      return [
        a.mirrorPad(i('x', s, e, t), i('padding', s, e, t), i('mode', s, e, t)),
      ];
    case 'PadV2':
    case 'Pad':
      return [
        a.pad(
          i('x', s, e, t),
          i('padding', s, e, t),
          i('constantValue', s, e, t),
        ),
      ];
    case 'SpaceToBatchND': {
      const r = i('blockShape', s, e, t),
        n = i('paddings', s, e, t);
    ...
    case 'DepthToSpace': {
      const r = i('blockSize', s, e, t),
        n = i('dataFormat', s, e, t).toUpperCase();
...
function Ut(s, e, t, a, r = L) {
  const n = ((u, o, l) => {
    switch (u.category) {
      ...
      case 'custom':
        const p = ri(u.op);
        if (p && p.customExecutor) return p.customExecutor(new Gg(u, o, l));
        throw TypeError(`Custom op ${u.op} is not registered.`);
      default:
        throw TypeError(
          `Unknown op '${u.op}'. File an issue at https://github.com/tensorflow/tfjs/issues so we can add it, or register a custom execution with tf.registerOp()`,
        );
    }
  })(s, e, t);
...
function Gt(s, e, t, a) {
  ...
  const l = /* @__PURE__ */ new Set(),
    p = new Set(Object.keys(s).map((d) => $(d)[0]));
  a = a || [];
  const m = new Set(a.map((d) => $(d.name)[0])),
    c = [...e];
  for (; c.length > 0; ) {
    const d = c.pop();
    if (
      ((G(d) || Ab(d) || Eb(d)) &&
        u == null &&
        ((u = d), (o = u.children.map((h) => h.name).filter((h) => r.has(h)))),
      r.add(d.name),
      t[d.name] == null && !p.has(d.name) && !m.has(d.name))
    ) {
...
function Nb(s, e) {
  const { usedNodes: t, inputs: a } = e,
    r = Object.keys(a)
      .map((f) => $(f)[0])
      .map((f) => s.nodes[f]),
    n = s.initNodes || [],
    u = (f) => t.has(typeof f == 'string' ? f : f.name);
  function o(f) {
    return [...new Map(f.map((b) => [b.name, b])).values()];
  }
  const l = o([...r, ...s.weights, ...n]).filter(u),
    p = o([...l, ...Object.values(s.nodes)]).filter(u),
    m = new Map(p.map((f) => [f.name, f])),
    c = {};
  for (const f of p) {
    c[f.name] = c[f.name] || 0;
    for (const b of f.children)
      u(b) || (c[b.name] = Number.POSITIVE_INFINITY),
        (c[b.name] = (c[b.name] || 0) + 1);
  }
  ...
  const N = h.map((f) => m.get(f)),
    g = wb(N, l);
  return Tb(g, l), g;
}
function wb(s, e) {
  const t = new Map(s.map((u) => [u.name, u])),
    a = e.map((u) => u.name),
    r = new Set(a);
  for (; a.length > 0; ) {
    const u = a.pop(),
...
function Tb(s, e) {
  const t = new Map(s.map((o, l) => [o.name, l])),
    a = new Set(e.map((o) => o.name)),
    r = (o) => a.has(typeof o == 'string' ? o : o.name),
    n = new Set(s.map((o) => o.name)),
    u = (o) => n.has(typeof o == 'string' ? o : o.name);
  for (const o of s) {
    for (const l of o.children.filter(u)) {
      ...
      if (t.get(o.name) > t.get(l.name))
        throw new ge(
          `Node ${o.name} is scheduled to run after its child ${l.name}.`,
        );
    }
    if (!r(o))
      for (const l of o.inputs) {
        ...
        if (t.get(l.name) > t.get(o.name))
          throw new ge(
            `Node ${o.name} is scheduled to run before its input ${l.name}.`,
          );
      }
  }
}
function Sb(s) {
  const e = new Map(s.map((o, l) => [o.name, l])),
    ...
    n = s.map((o, l) =>
      o.children.map(r).reduce((p, m) => Math.max(p, m), a[l]),
    ),
    u = /* @__PURE__ */ new Map();
...
class Ie {
   ...
   */
  compile(e, t) {
    const a = Gt(e, t, this.weightMap, this._initNodes),
      { missingInputs: r, dynamicNode: n, syncInputs: u } = a;
    if (n != null)
      throw new Error(
        `This execution contains the node '${n.name}', which has the dynamic op '${n.op}'. Please use model.executeAsync() instead. Alternatively, to avoid the dynamic ops, specify the inputs [${u}]`,
      );
    if (r.length > 0) {
      const p = t.map((c) => c.name),
        m = Object.keys(e);
      throw new Error(
        `Cannot compute the outputs [${p}] from the provided inputs [${m}]. Missing the following inputs: [${r}]`,
      );
    }
    const o = Nb(this.graph, a),
      l = Sb(o);
  ...
  cloneTensorMap(e) {
    return Object.fromEntries(
      Object.entries(e).map(([t, a]) => [t, this.cloneTensorList(a)]),
    );
  }
  /**
  ...
  execute(e, t) {
    ...
    this.checkInputs(e),
      ...
      (t = this.mapOutputs(t)),
      this.checkOutputs(t);
    const r = a.map((d) => this.graph.nodes[$(d)[0]]),
      n = t.map((d) => $(d)[0]),
      u = new Set(n);
      ...
      this.keepIntermediateTensors &&
        ...
        Object.keys(e).forEach((b) => {
          ...
          (T[_] = e[b]),
            (h[O] = T),
            this.keepIntermediateTensors &&
              (this.clonedTensorsMap[O] = this.cloneTensorList(T));
        });
      const N = this.getFrozenTensorIds(h),
        { orderedNodes: g, nodeLiveUntilMap: f } = p;
      for (const b of g) {
        if (h[b.name]) continue;
        const O = Ut(b, h, d, this._resourceManager);
        if (Ae(O))
          throw new Error(
            `The execution of the op '${b.op}' returned a promise. Please use model.executeAsync() instead.`,
          );
        (h[b.name] = O),
          this.keepIntermediateTensors &&
            (this.clonedTensorsMap[b.name] = this.cloneTensorList(O)),
  ...
  checkTensorForDisposal(e, t, a, r, n, u, o) {
    if (!(G(t) || u.has(e))) {
      ...
      for (const l of t.inputs) {
        ...
        if (p != null)
          for (const m of p) {
            if (!m || m.kept || n.has(m.id)) continue;
            const c = o[m.id];
  ...
  checkTensorForDisposalWithNodeLiveUntilInfo(e, t, a, r, n, u) {
    ...
    if (!(G(e) || u == null))
      for (const l of u) {
        ...
        for (const m of p) !m || m.kept || r.has(m.id) || m.dispose();
      }
  }
  /**
  ...
  async _executeAsync(e, t, a = !1, r = {}, n = {}) {
    ...
    this.keepIntermediateTensors &&
      (this.clonedTensorsMap = this.cloneTensorMap(this.weightMap));
    const o = await this.executeWithControlFlow(e, u, t, a),
      l = t.map((d) => E(d, o, u)),
      p = l.map((d) => d.id),
      m = Object.keys(e).map((d) => e[d].id),
      c = /* @__PURE__ */ new Set([...p, ...m, ...this.weightIds]);
    return (
  ...
  async executeWithControlFlow(e, t, a, r) {
    const n = Object.keys(e),
      u = n.map((T) => this.graph.nodes[$(T)[0]]),
      o = a.map((T) => $(T)[0]),
      l = new Set(o);
    ...
    const {
        ...
        dynamicNode: d,
        syncInputs: h,
      } = Gt(e, p, this.weightMap, this._initNodes),
      N = [...u, ...this.graph.weights, ...(this._initNodes || [])].map(
        (T) => ({ node: T, contexts: t.currentContext }),
      ),
    ...
    if (_.length > 0) {
      ...
      throw (
        (d != null &&
          (T = `Alternatively, to avoid the dynamic ops, use model.execute() and specify the inputs [${h}]`),
        new Error(
          `Cannot compute the outputs [${_}] from the provided inputs [${n}]. Consider providing the following inputs: [${c}]. ${T}`,
        ))
      );
    }
    return g;
    ...
    for (; t.length > 0; ) {
      ...
      if (
        ...
        Ae(h)
          ? m.push(
              h.then(
                (g) => (
                  (r[d] = g),
                  this.keepIntermediateTensors &&
                    (this.clonedTensorsMap[d] = this.cloneTensorList(g)),
                  (a.currentContext = N),
                  this.checkTensorForDisposal(d, c.node, r, a, u, o, l),
          ...
          : ((r[d] = h),
            this.keepIntermediateTensors &&
              (this.clonedTensorsMap[d] = this.cloneTensorList(h)),
            this.checkTensorForDisposal(d, c.node, r, a, u, o, l),
            this.processChildNodes(c.node, t, a, r, n, p));
      } else this.processChildNodes(c.node, t, a, r, n, p);
    }
    return m;
  }
  processChildNodes(e, t, a, r, n, u) {
    e.children.forEach((o) => {
      ...
      n[l] ||
        !u.has(o.name) ||
        (o.op === 'Merge'
          ? o.inputNames.some((p) => !!E(p, r, a)) &&
            ((n[l] = !0), t.push({ contexts: a.currentContext, node: o }))
          : o.inputNames.every((p) => !!E(p, r, a)) &&
            ((n[l] = !0), t.push({ contexts: a.currentContext, node: o })));
    });
  }
  /**
  ...
  dispose() {
    Object.keys(this.weightMap).forEach((e) =>
      this.weightMap[e].forEach((t) => t.dispose()),
    );
  }
  checkInputShapeAndType(e) {
    Object.keys(e).forEach((t) => {
      ...
      if (n.attrParams.shape && n.attrParams.shape.value) {
        const u = n.attrParams.shape.value,
          o =
            u.length === a.shape.length &&
            a.shape.every((l, p) => u[p] === -1 || u[p] === l);
        w(
          o,
          () =>
            `The shape of dict['${n.name}'] provided in model.execute(dict) must be [${u}], but was [${a.shape}]`,
        );
      }
      n.attrParams.dtype &&
  ...
  mapInputs(e) {
    ...
    for (const n in e) {
      const u =
        (a =
          (t = this._signature) === null || t === void 0
            ? void 0
            : t.inputs) === null || a === void 0
          ? void 0
          : a[n];
  ...
  mapOutputs(e) {
    return e.map((t) => {
      ...
      const n =
        (r =
          (a = this._signature) === null || a === void 0
            ? void 0
            : a.outputs) === null || r === void 0
          ? void 0
          : r[t];
...
class Et {
  ...
  load() {
    ...
    return Ae(e)
      ? e.then((t) =>
          t.getWeightStream == null ? this.loadSync(t) : this.loadStreaming(t),
        )
      : this.loadSync(e);
  }
  /**
  ...
  loadWithWeightMap(e, t) {
    ...
    if (this.artifacts.userDefinedMetadata != null) {
      ...
      n.signature != null && (r = n.signature),
        n.structuredOutputKeys != null &&
          (this.structuredOutputKeys = n.structuredOutputKeys);
    }
    if (
      ((this.signature = r),
      (this.version = `${a.versions.producer}.${a.versions.minConsumer}`),
      (this.executor = new Ie(jt.Instance.transformGraph(a, this.signature))),
  ...
  async save(e, t) {
    if (typeof e == 'string') {
      ...
      if (a.length > 1)
        throw new Error(
          `Found more than one (${a.length}) save handlers for URL '${e}'`,
        );
      e = a[0];
    }
    if (e.save == null)
  ...
  normalizeInputs(e) {
    ...
    if (!(e instanceof me) && !Array.isArray(e)) {
      const n =
        (t = this.signature) === null || t === void 0 ? void 0 : t.inputs;
      if (n != null)
        for (const u in n) {
          const o = n[u];
          o.resourceId != null &&
            (e[u] = this.resourceIdToCapturedInput[o.resourceId]);
        }
      return e;
    }
    ...
    if (e.length + a !== this.inputNodes.length)
      throw new Error(
        `Input tensor count mismatch, the graph model has ${this.inputNodes.length - a} non-resource placeholders, while there are ${e.length} input tensors provided.`,
      );
    let r = 0;
    return this.inputNodes.reduce((n, u) => {
      ...
      const m =
        (p =
          (l =
            (o = this.signature) === null || o === void 0
              ? void 0
              : o.inputs) === null || l === void 0
            ? void 0
            : l[u]) === null || p === void 0
          ? void 0
          : p.resourceId;
      return (
        m != null
          ? (n[u] = this.resourceIdToCapturedInput[m])
          : (n[u] = e[r++]),
        n
      );
    }, {});
  ...
  dispose() {
    this.executor.dispose(),
      this.initializer &&
        ...
        this.resourceIdToCapturedInput && en(this.resourceIdToCapturedInput)),
...
function Cb(s) {
  ...
  if (s instanceof Array) {
    ...
    const n = Ns(a.weightsManifest),
      u = bs(a, n, r);
    e = Ee(u);
  } else if ('load' in s) e = s;
...
const be = '"',
  ...
  Kt = Symbol('field'),
  Ne = Symbol('quote'),
  Pe = Symbol('quoteafterquote'),
  Jt = Symbol('quoteinquote');
class li extends gt {
  /**
  ...
  async setColumnNames() {
    ...
    this.fullColumnNames &&
      e &&
      w(
        e.length === this.fullColumnNames.length,
        () =>
      ...
      this.fullColumnNames || (this.fullColumnNames = e);
    const t = this.fullColumnNames.reduce(
        (r, n) => ((r[n] = r[n] + 1 || 1), r),
        {},
      ),
      a = Object.keys(t).filter((r) => t[r] > 1);
    if (
      (w(a.length === 0, () => 'Duplicate column names found: ' + a.toString()),
      this.columnConfigs)
    ) {
  ...
  constructor(e, t) {
    super(),
      ...
      (this.fullColumnNames = t.columnNames),
      (this.columnConfigs = t.columnConfigs),
      (this.configuredColumnsOnly = t.configuredColumnsOnly),
      t.delimWhitespace
        ? (w(
            t.delimiter == null,
            () =>
          ...
          (this.delimiter = ' '))
        : (this.delimiter = t.delimiter ? t.delimiter : ',');
  }
  async iterator() {
    this.columnNamesValidated || (await this.setColumnNames());
    let e = await this.base.iterator();
    return (
      this.hasHeader && (e = e.skip(1)), e.map((t) => this.makeDataElement(t))
    );
  }
  makeDataElement(e) {
    const t = this.parseRow(e),
      a = {},
      r = {};
    for (let n = 0; n < this.fullColumnNames.length; n++) {
      const u = this.fullColumnNames[n],
        o = this.columnConfigs ? this.columnConfigs[u] : null;
      if (!(this.configuredColumnsOnly && !o)) {
        const l = t[n];
        let p = null;
        if (l === '')
          if (o && o.default !== void 0) p = o.default;
          else {
            if (o && (o.required || o.isLabel))
              throw new Error(
                `Required column ${u} is empty in this line: ${e}`,
              );
            p = void 0;
          }
        else {
  ...
  parseRow(e, t = !0) {
    ...
    if (
      (u === Pe ? a.push(e.substring(r, n - 1)) : a.push(e.substring(r)),
      t && a.length !== this.fullColumnNames.length)
    )
      throw new Error(
        `Invalid row in csv file. Should have ${this.fullColumnNames.length} elements in a row, but got ${a}`,
      );
    return a;
  }
}
...
class kt extends De {
  constructor(e) {
    ...
    if (
      ((this.numFrames = e.numFramesPerSpectrogram || 43),
      (this.sampleRateHz = e.sampleRateHz),
      (this.columnTruncateLength = e.columnTruncateLength || this.fftSize),
      (this.audioTrackConstraints = e.audioTrackConstraints),
      (this.smoothingTimeConstant = e.smoothingTimeConstant || 0),
      (this.includeSpectrogram = e.includeSpectrogram !== !1),
      (this.includeWaveform = e.includeWaveform === !0),
  ...
  async start() {
    try {
      this.stream = await navigator.mediaDevices.getUserMedia({
        audio:
          this.audioTrackConstraints == null ? !0 : this.audioTrackConstraints,
        video: !1,
      });
    } catch (a) {
      throw new Error(
        `Error thrown while initializing video stream: ${a.message}`,
      );
    }
    if (!this.stream)
      ...
      const n = setInterval(
        () => {
          this.includeSpectrogram &&
            ...
            this.freqData[0] === -1 / 0 &&
              r({ freqDataQueue: e, timeDataQueue: t }),
            e.push(this.freqData.slice(0, this.columnTruncateLength))),
            this.includeWaveform &&
              (this.analyser.getFloatTimeDomainData(this.timeData),
              t.push(this.timeData.slice())),
            ++a === this.numFrames &&
              (clearInterval(n), r({ freqDataQueue: e, timeDataQueue: t }));
        },
  ...
  constructor(e, t) {
    if (
      ...
      if (
        ...
        (this.cropBoxInd = yt([0], 'int32')),
        this.webcamConfig.centerCrop)
      ) {
        const a =
            (this.webcamConfig.resizeWidth * 1) / this.webcamVideoElement.width,
          r =
            (this.webcamConfig.resizeHeight * 1) /
      ...
      } else this.cropBox = _e([0, 0, 1, 1], [1, 4]);
  }
  summary() {
    return 'webcam';
  }
...
class Lb extends tn {
  ...
  async pump() {
    ...
    for (const a of t.slice(0, -1)) this.outputQueue.push(a);
...
class Vb extends tn {
  ...
  async pump() {
    ...
    return (
      P().get('IS_BROWSER')
        ? (a = this.decoder.decode(t, { stream: !0 }))
        : (a = this.decoder.write(Buffer.from(t.buffer))),
...
class ci extends Pb {
    ...
    super(),
      ...
      w(
        e instanceof Uint8Array ||
          (P().get('IS_BROWSER') ? e instanceof File || e instanceof Blob : !1),
        () =>
          'FileChunkIterator only supports File, Blob and Uint8Array right now.',
      ),
      (this.offset = t.offset || 0),
      (this.chunkSize = t.chunkSize || 1024 * 1024);
  }
  summary() {
  ...
  async next() {
    return this.offset >=
      (this.file instanceof Uint8Array ? this.file.byteLength : this.file.size)
      ? { value: null, done: !0 }
      : {
          value: await new Promise((t, a) => {
            ...
            if (this.file instanceof Uint8Array)
              ...
              (n.onload = (o) => {
                ...
                (n.onabort = (o) => a(new Error('Aborted'))),
                (n.onerror = (o) => a(new Error(o.type)));
...
async function Rb(s, e = {}, t) {
  ...
  if (n.ok) {
    ...
    return new ci(u, e);
  } else throw new Error(n.statusText);
}
const jb = (s) => ({
  method: s.method,
  headers: s.headers,
...
class fi extends pi {
  ...
  async iterator() {
    return di(this.url)
      ? new hi(this.url, this.fileOptions).iterator()
      : Rb(this.url, this.fileOptions);
  }
}
/**
 * @license
 ...
 * =============================================================================
 */
const Gb = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      CSVDataset: li,
...
class Zb {
  constructor({
    ...
    (this.container = e),
      (this.imageTargetSrc = t),
      (this.maxTrack = a),
      (this.filterMinCF = o),
      (this.filterBeta = l),
      (this.warmupTolerance = p),
      (this.missTolerance = m),
      (this.ui = new Rd({ uiLoading: r, uiScanning: n, uiError: u })),
      (this.userDeviceId = c),
      (this.environmentDeviceId = d),
      (this.shouldFaceUser = !1),
      (this.scene = new Ct()),
      (this.cssScene = new Ct()),
      (this.renderer = new Ti({ antialias: !0, alpha: !0 })),
      (this.cssRenderer = new Vd({ antialias: !0 })),
      (this.renderer.outputEncoding = Si),
  ...
  _startVideo() {
    return new Promise((e, t) => {
      ...
      this.shouldFaceUser
        ? this.userDeviceId
          ? (a.video.deviceId = { exact: this.userDeviceId })
          : (a.video.facingMode = 'user')
        : this.environmentDeviceId
          ? (a.video.deviceId = { exact: this.environmentDeviceId })
          : (a.video.facingMode = 'environment'),
  ...
  _startAR() {
    return new Promise(async (e, t) => {
      ...
      this.container,
            ...
            if (n.type === 'updateMatrix') {
              ...
              for (let p = 0; p < this.anchors.length; p++)
                if (this.anchors[p].targetIndex === u) {
                  if (
                    (this.anchors[p].css
                      ? this.anchors[p].group.children.forEach((m) => {
                          m.element.style.visibility =
                            o === null ? 'hidden' : 'visible';
                        })
                      : (this.anchors[p].group.visible = o !== null),
                    o !== null)
                  ) {
                    let m = new Te();
                    (m.elements = [...o]),
                      m.multiply(this.postMatrixs[u]),
                      this.anchors[p].css && m.multiply(Ni),
                      (this.anchors[p].group.matrix = m);
                  } else this.anchors[p].group.matrix = Xb;
                  this.anchors[p].visible &&
                    o === null &&
                    ((this.anchors[p].visible = !1),
                    this.anchors[p].onTargetLost &&
                      this.anchors[p].onTargetLost()),
                    !this.anchors[p].visible &&
                      o !== null &&
                      ((this.anchors[p].visible = !0),
                      this.anchors[p].onTargetFound &&
                        this.anchors[p].onTargetFound()),
                    this.anchors[p].onTargetUpdate &&
                      this.anchors[p].onTargetUpdate();
                }
              this.anchors.reduce((p, m) => p || m.visible, !1)
        ...
        this.resize();
      const { dimensions: r } = await this.controller.addImageTargets(
        this.imageTargetSrc,
      );
      this.postMatrixs = [];
  ...
  resize() {
    ...
    const l = n.videoWidth / n.videoHeight,
      p = r.clientWidth / r.clientHeight;
    l > p
      ? ((o = r.clientHeight), (u = o * l))
      : ((u = r.clientWidth), (o = u / l));
    const m = this.controller.getProjectionMatrix(),
      c = this.controller.inputWidth / this.controller.inputHeight;
    let d;
    c > p
      ? (d = this.video.width / this.controller.inputWidth)
      : (d = this.video.height / this.controller.inputHeight);
    let h, N;
    c > p
      ? ((h = r.clientHeight), (h *= d))
      : ((N = r.clientWidth),
        (h = (N / this.controller.inputWidth) * this.controller.inputHeight),
        (h *= d));
    let g = r.clientHeight / h;
    const f = (2 * Math.atan((1 / m[5]) * g) * 180) / Math.PI,
      b = m[14] / (m[10] - 1),
      O = m[14] / (m[10] + 1);
    m[5] / m[0],
      (a.fov = f),
      ...
      (n.style.top = -(o - r.clientHeight) / 2 + 'px'),
      (n.style.left = -(u - r.clientWidth) / 2 + 'px'),
      (n.style.width = u + 'px'),
      (n.style.height = o + 'px');
    ...
    (_.style.position = 'absolute'),
      (_.style.left = 0),
      (_.style.top = 0),
      (_.style.width = r.clientWidth + 'px'),
      (_.style.height = r.clientHeight + 'px'),
      (T.style.position = 'absolute'),
      (T.style.left = 0),
      (T.style.top = 0),
      (T.style.width = r.clientWidth + 'px'),
      (T.style.height = r.clientHeight + 'px'),
